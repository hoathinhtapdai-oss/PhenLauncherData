ServerEvents.recipes(event => {
	...
	event.remove({ output: 'farmersrespite:purulent_tea' })
	event.remove({ output: 'farmersrespite:long_purulent_tea' })
	event.remove({ output: 'farmersrespite:strong_purulent_tea' })
})